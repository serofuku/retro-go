...
// Use internal flash VFS instead of an SD card.
#define RG_STORAGE_ROOT             "/vfs"
#define RG_STORAGE_FLASH_PARTITION  "vfs"

// SD card disabled for this build.
...
// DO NOT CHANGE THESE.
// This is your known-working screen configuration.
...
// Refer to rg_input.h to see all available
// RG_KEY_* and RG_GAMEPAD_*_MAP types
...
#define RG_BATTERY_CALC_PERCENT(raw) \
    (((raw) * 2.f - 3500.f) / (4200.f - 3500.f) * 100.f)

#define RG_BATTERY_CALC_VOLTAGE(raw) \
    ((raw) * 2.f * 0.001f)
...
// KEEP EXACTLY AS YOUR WORKING ORIGINAL CONFIG.
...
// Disabled because we're using internal flash VFS.
